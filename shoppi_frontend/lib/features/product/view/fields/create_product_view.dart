...
import '../../../../core/view/widget/textfield/outline_text_field.dart';
...
class _CreateProductViewState extends State<CreateProductView> {
  ...
  Widget get showImageButton => FloatingActionButton.extended(
      onPressed: () => showImage(), label: const Text("Show Image"));
  ...
  void onConfirmModel() {
    if (formKey!.currentState!.validate()) {
      ...
      model!.weight = double.parse(weightController!.text.toString());
